...
def sort_results_by_NNN(inFileName,outFileName):
     ...
     fileHeader = ["TRatio","TOligo","ARatio","AOligo","CRatio","COligo","GRatio","GOligo"]
     ...
     listOfLists = [tRatio,tOligo,aRatio,aOligo,cRatio,cOligo,gRatio,gOligo]
...
def read_first_col_of_file(inFileName):
     ...
     for line in inFile:
          # create a temporary list to hold all values on that line separated by a "tab"
          tempList = line.split('\t')
