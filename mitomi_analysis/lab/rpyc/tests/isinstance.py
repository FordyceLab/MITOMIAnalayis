...
assert issubclass(c.modules.__builtin__.str, c.modules.__builtin__.str) == True
assert issubclass(c.modules.__builtin__.str, (list, c.modules.__builtin__.str)) == True
...
assert issubclass(str, c.modules.__builtin__.str) == True
assert issubclass(str, (int, c.modules.__builtin__.str)) == True
